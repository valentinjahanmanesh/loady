...
class LoadyBackgroundHighlighterAnimation: LoadyAnimation, LoadyPercentageObserver {
	...
	static var animationTypeKey: LoadyAnimationType.Key = .init(rawValue: "backgroundHighlighter")
